...
public class AvatarSelectionManager : MonoBehaviour
{
    ...
    public AvatarController avatarInputConverter;
    ...
    private void LoadAvatarModelAt(int avatarIndex)
    {
        ...
        avatarInputConverter.AvatarTranformPosition = loadableAvatarModels[avatarIndex].GetComponent<AvatarHolder>().MainAvatarTransform;
        ...
        avatarInputConverter.Avatar_Hand_Left = loadableAvatarModels[avatarIndex].GetComponent<AvatarHolder>().HandLeftTransform;
        avatarInputConverter.Avatar_hand_Right = loadableAvatarModels[avatarIndex].GetComponent<AvatarHolder>().HandRightTransform;
